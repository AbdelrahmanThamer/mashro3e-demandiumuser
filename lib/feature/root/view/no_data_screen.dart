  ...
  Widget build(BuildContext context) {
    return Container(
      child: Column(
        ...
        if(type != NoDataType.CATEGORY_SUBCATEGORY && type != NoDataType.INBOX && type != NoDataType.BOOKING && type != NoDataType.SERVICE  &&type != NoDataType.SEARCH  && type != NoDataType.OFFERS && type != NoDataType.CART && type != NoDataType.ADDRESS && type != NoDataType.HOME && type != NoDataType.COUPON && isShowHomePage )
        CustomButton(
          height: 40, width: 200,
