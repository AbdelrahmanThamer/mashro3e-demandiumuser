...
class ServiceInformationCard extends StatelessWidget {
  ...
  const ServiceInformationCard({Key? key, required this.discount, required this.service, required this.lowestPrice, required this.scaffoldState}) : super(key: key);
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: CustomImage(
                            ...
                            fit: BoxFit.cover,
                            placeholder: Images.placeholder, height:ResponsiveHelper.isMobile(context) ? Dimensions.IMAGE_SIZE_LARGE :Dimensions.IMAGE_SIZE_MEDIUM, width:ResponsiveHelper.isMobile(context) ? Dimensions.IMAGE_SIZE_LARGE: Dimensions.IMAGE_SIZE_MEDIUM,
                          ),
                        ),
