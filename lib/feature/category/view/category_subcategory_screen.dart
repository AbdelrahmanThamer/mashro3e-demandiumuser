                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    ...
                    SliverToBoxAdapter(
                      ...
                      Center(
                        child: Container(
                          height:ResponsiveHelper.isTab(context) ? 140 : ResponsiveHelper.isWeb()? 135 : 130,
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  width: ResponsiveHelper.isDesktop(context) ? MediaQuery.of(context).size.width/11 :MediaQuery.of(context).size.width/4.5,
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: CustomImage(
                                            ...
                                            height: ResponsiveHelper.isTab(context) ? 60 : ResponsiveHelper.isWeb()?50:40,
                                            width: ResponsiveHelper.isDesktop(context) ? 50 : MediaQuery.of(context).size.width/8 ,
