                        ...
                        child: Center(child: SizedBox(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Text('find_services_near_you'.tr, textAlign: TextAlign.center, style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Theme.of(context).colorScheme.primary),),
                                  Padding(
                                    padding: EdgeInsets.all(Dimensions.PADDING_SIZE_LARGE),
                                    child: Text('please_select_you_location_to_start_exploring_available_services_near_you'.tr, textAlign: TextAlign.center, style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).colorScheme.primary),),),
