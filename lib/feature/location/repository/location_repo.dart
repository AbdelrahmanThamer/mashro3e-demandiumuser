...
class LocationRepo {
  ...
  Future<Response> getZone(String lat, String lng) async {
    ...
    return await apiClient.getData('${AppConstants.ZONE_URI}?lat=$lat&lng=$lng',headers: mainHeaders);
  }
  ...
  Future<Response> getAddressFromGeocode(LatLng? latLng) async {
    ...
    return await apiClient.getData('${AppConstants.GEOCODE_URI}?lat=${latLng!.latitude}&lng=${latLng.longitude}',headers: mainHeaders);
  }
