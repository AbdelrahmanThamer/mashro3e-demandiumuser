...
class LocationController extends GetxController implements GetxService {
  ...
  Future<void> getAddressList() async {
    ...
    _addressList = _addressList!.reversed.toList();
    _isLoading = false;
    _addLocalAddress(_addressList!);
    update();
  }

  _addLocalAddress(List<AddressModel> _addressLis) {
    ...
    if(getUserAddress() != null){
      bool _isAddressContain = _addressList!.where((element) => element.address == getUserAddress()?.address).isNotEmpty;
