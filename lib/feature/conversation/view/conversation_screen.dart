...
class ConversationScreen extends StatefulWidget {
  ...
  ConversationScreen({ required this.name, required this.image, required this.channelID,required this.date,required this.bookingID});
  @override
                  ...
                  return Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Expanded(
                          child:conversationList.length>0 ? ListView.builder(
