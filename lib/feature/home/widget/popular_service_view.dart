                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child:ListView.builder(
                      ...
                      itemCount: serviceController.popularServiceList!.length > 10 ? 10 : serviceController.popularServiceList!.length,
                      itemBuilder: (context, index){
                        controller.getServiceDiscount(serviceController.popularServiceList![index]);
                        Discount _discountModel =  PriceConverter.discountCalculation(serviceController.popularServiceList![index]);
                        Service service = serviceController.popularServiceList!.elementAt(index);
