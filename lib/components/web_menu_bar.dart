  ...
  Widget build(BuildContext context) {
    return Center(child: Container(
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.only(bottomRight: Radius.circular(Dimensions.RADIUS_DEFAULT),bottomLeft: Radius.circular(Dimensions.RADIUS_DEFAULT))
      ),
      ...
      child: Row(children: [
        ...
        InkWell(
          ...
          child: Image.asset(Get.isDarkMode?Images.webAppbarLogoDark:Images.webAppbarLogo,width: 140),
        ),
                  ...
                  Flexible(
                    child: Text(
                      ...
                      style: ubuntuRegular.copyWith(
                        color: Theme.of(context).textTheme.bodyText1!.color, fontSize: Dimensions.fontSizeExtraSmall,
                      ),
