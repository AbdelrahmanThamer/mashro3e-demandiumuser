...
class AppConstants {
  ...
  static const String OTHERS_INFO = '/api/v1/customer/cart/other-infos';
  ...
  static const String COUPON_URI = '/api/v1/customer/coupon?limit=100&offset=1&status=all&coupon_type=all';
