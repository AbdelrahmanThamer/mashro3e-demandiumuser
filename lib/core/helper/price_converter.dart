...
class PriceConverter {
  ...
  static Discount _getDiscount(List<ServiceDiscount>? serviceDiscountList, int? _discountAmount, String? _discountAmountType) {
    ...
    if(serviceDiscount != null){
      int? _getDiscount = int.tryParse('${serviceDiscount.discount?.discountAmount.toString()}');
