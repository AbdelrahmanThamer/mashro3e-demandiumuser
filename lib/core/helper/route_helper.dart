...
class RouteHelper {
  ...
  static String getSplashRoute(String? bookingID) {
    String _data = 'null';
    if(bookingID != null) {
      List<int> _encoded = utf8.encode(jsonEncode(bookingID));
  ...
  static String getCheckoutRoute(String page,String currentPage,String addressId) => '$checkout?currentPage=$currentPage&addressID=$addressId';
  ...
  static String getChatScreenRoute(
      ...
      String date,
      String bookingID){
    return '$chatScreen?channelID=$channelId&name=$name&image=$image&date=$date&bookingID=$bookingID';
  }
  ...
  static String getRateReviewScreen(
    ...
    String _data = base64Encode(_encoded);
    return '$rateReviewScreen?serviceID=$serviceID&bookingIDForReview=$bookingIDForReview&bookingDetailsContent=$_data&index=$index&variantKey=$variantKey';
  }
  ...
  static String subCategoryScreenRoute(String categoryName) => '$subCategoryScreen?category_name=$categoryName';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: splash, page: () {
      ...
      if(Get.parameters['data'] != 'null') {
        ...
        _data = jsonDecode(utf8.decode(_decode));
      }
      return SplashScreen(bookingID: _data != null ? _data:null);
    }),
    ...
    GetPage(
      ...
      GetPage(
          ...
          name: checkout, page: () {
            return getRoute(CheckoutScreen( Get.parameters['currentPage']!, Get.parameters['addressID']!));
      }),
      GetPage(
    ...
    GetPage(name: services, page: () => getRoute(ServicesScreen())),
    GetPage(name: chatScreen, page: () => getRoute(
      ...
      GetPage(binding: ServiceBinding(),name: subCategoryScreen, page: ()=> SubCategoryScreen(categoryTitle: Get.parameters['category_name']!,),),
      GetPage(
        ...
        BookingDetailsContent _data = BookingDetailsContent.fromJson(jsonDecode(utf8.decode(_decode)));
          return RateReviewScreen(
            bookingDetailsContent : _data,
            serviceID: Get.parameters['serviceID']!,
            bookingIDForReview: Get.parameters['bookingIDForReview']!,
            index : int.parse(Get.parameters['index']!),
            variantKey:Get.parameters['variantKey']!
          );
          },),
